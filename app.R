...
#tabItem(tabName = "ringkasan",
   #     actionButton("refresh", "REFRESH TABEL"),
    #    tableOutput("res"), tags$hr()),  
  
tabItem(tabName = "dashboard",
     #  img(src = "logo-pds.png", height = 140, width = 400),
      #  imageOutput("myImage")
     fluidRow(column(2,htmlOutput("picture")),
              #column(2,htmlOutput("picture1")),
     ...
     #box(title = strong("PROGRESS PEKERJAAN"),plotOutput("graf15"),width =4)
     )
        ),
